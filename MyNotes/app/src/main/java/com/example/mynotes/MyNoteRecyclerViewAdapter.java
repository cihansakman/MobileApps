...
public class MyNoteRecyclerViewAdapter extends RecyclerView.Adapter<MyNoteRecyclerViewAdapter.ViewHolder> {
    ...
    private NoteFragment.OnNoteListIteractionListener mListener;

    public MyNoteRecyclerViewAdapter(ArrayList<Note> mValues, NoteFragment.OnNoteListIteractionListener mListener) {
